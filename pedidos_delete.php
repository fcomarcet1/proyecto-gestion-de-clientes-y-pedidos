...
if (isset($_REQUEST["idPedido"])) {
  ...
  $sqldelete = "DELETE FROM tblpedidos WHERE idPedido='" .  $id . "'";
  if (mysqli_query($conexionpedidos, $sqldelete)) {
    header("location:pedidos_lista.php");
    exit();
  } else {
    echo "Error al eliminar el Pedido: " . mysqli_error($conexionpedidos);
  }
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
        <!-- /.container-fluid -->
        <?php include_once("includes/contenido_table.php"); ?>
      </div>
      <!-- End of Main Content -->
      <!-- Footer -->
